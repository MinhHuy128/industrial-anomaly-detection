### Table 1: ViTill-GCT (Proposed Dual-Stream)

| Category | Logical AUROC (%) | Structural AUROC (%) | Mean AUROC (%) | sPRO (AUPRO ≤ 0.30) (%) | Latency (ms) | FPS |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
